...
helm show values cnpg/cloudnative-pg --version 0.28.0 > ./storage/postgres-cnpg/default-values.yaml
```

```bash

# cnpg helm charts and main repo tags use off-by-one different numbering
kubectl kustomize "github.com/cloudnative-pg/cloudnative-pg/config/crd?ref=v1.29.0" > ./storage/postgres-cnpg/crd.yaml
