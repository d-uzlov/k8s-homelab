...
checkEnv FORCE_OVERWRITE_WATCH_FILE "true false"
...
if [ "$FORCE_OVERWRITE_CONFIG" = "true" ] || [ "$FORCE_OVERWRITE_WATCH_FILE" = "true" ] || [ ! -f "$watchFile" ]; then
...
# without this the script can fail because
