...
```bash
 ...
 sed -i 's/\"version\"\: [0-9]*/\"version\": 0/' ./metrics/component-monitoring/harbor/dashboards/*.json
 ...
 sed -i 's/^  \"refresh\": \".*s\",/  \"refresh\": \"auto\",/' ./metrics/component-monitoring/harbor/dashboards/*.json
 ...
 sed -i -z -r 's/,\n *\"value\": null(\n *})/\1/g' ./metrics/component-monitoring/harbor/dashboards/*.json
