...
```bash
 ...
 sed -i 's/\"version\"\: [0-9]+/\"version\": 0/' ./metrics/component-monitoring/k8s-control-plane/dashboards/*.json
 ...
 sed -i -z -r 's/,\n *\"value\": null(\n *})/\1/g' ./metrics/component-monitoring/k8s-control-plane/dashboards/*.json
