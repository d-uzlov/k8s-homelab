...
helm show values istio/base --version 1.30.1 > ./ingress/istio/base/default-values.yaml
...
helm show values istio/istiod --version 1.30.1 > ./ingress/istio/istiod/default-values.yaml
